...
So why is the hype machine exploding at the seams to get everyone using and making agents?
...
In general, developers who are wholesale adopting AI in their workflows are using tools like [OpenCode](https://opencode.ai/), [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview), [Pi](https://pi.dev/), and other developer-focused harnesses. 
...
A purpose-built agent would be designed to use a framework like [langchain](https://www.langchain.com/), [agent-core](https://aws.amazon.com/bedrock/agentcore/), or my personal favorite, [dspy](https://dspy.ai/). These frameworks provide enough code for the developer to quickly write a workflow - more akin to basic instructions to follow: when given X input, follow Y instructions, and produce Z output. 
...
But if you've made it this far, my hot take on all this is: Purpose-built agents, which can be tested and evaluated, optimized, and reliably produce proper workflow outputs are what businesses _actually_ want. The reliability is really what they are after, and that is extremely difficult when you try to contain a "lobster". 
...
If all three of those were yes, then you need something more containable than letting loose a harness connected to every API you can control, and you can probably just have a coding harness develop a script for you to run on a periodic cron job. 
